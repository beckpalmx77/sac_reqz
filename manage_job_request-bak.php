...
if (strlen($_SESSION['alogin']) == "") {
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="job_problem_detail_id" class="control-label">รหัสคำตอบ</label>
                                                                    <input type="job_problem_detail_id" class="form-control"
                                                                           id="job_problem_detail_id" name="job_problem_detail_id"
                                                                           readonly="true"
    ...
    <script>
        ...
        $("#job_problem_detail").blur(function () {
            let method = $('#action').val();
            if (method === "ADD") {
                let job_problem_detail_id = $('#job_problem_detail_id').val();
                let job_problem_detail = $('#job_problem_detail').val();
                let formData = {action: "SEARCH", job_problem_detail_id: job_problem_detail_id, job_problem_detail: job_problem_detail};
                $.ajax({
        ...
        $("#TableRecordList").on('click', '.delete', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    for (let i = 0; i < len; i++) {
                        let id = response[i].id;
                        let job_problem_detail_id = response[i].job_problem_detail_id;
                        let job_id = response[i].job_id;
                        let device_desc = response[i].device_desc;
                        let job_problem_detail = response[i].job_problem_detail;
                        let status = response[i].status;
                        ...
                        $('#job_id').val(job_id);
                        $('#device_desc').val(device_desc);
                        $('#job_problem_detail_id').val(job_problem_detail_id);
